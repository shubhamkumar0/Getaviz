...
public class OutputFormatHelper {
	...
	public static String AFrameHead() {
		...
		builder.append("\n");
		builder.append("\t <script src=\"aframe-v0.8.2.min.js\"></script>");
		builder.append("\n");
		builder.append("\t <script type=\"text/javascript\" src=\"scripts/camera-beta.js\"></script>");
		builder.append("\n");
		builder.append("\t <script src=\"scripts/vertex-colors-buffer.js\"></script>");
		builder.append("\n");
		builder.append("\t <script src=\"scripts/aframe-geometry-merger-component.min.js\"></script>");
		builder.append("\n");
		builder.append("\t <script>");
		builder.append("\n");
		builder.append("\t\t AFRAME.registerComponent('buffer-geometry-merger', {");
		builder.append("\n");
		builder.append("schema: { preserveOriginal: {default: false} },");
		builder.append("\n");
		builder.append("init: function () {");
		builder.append("\n");
		builder.append("var geometries = [];");
		builder.append("\n");
		builder.append("this.el.sceneEl.object3D.updateMatrixWorld()");
		builder.append("\n");
		builder.append("this.el.object3D.traverse(function (mesh) {");
		builder.append("\n");
		builder.append("if (mesh.type !== 'Mesh' || mesh.el === self.el) { return; }");
		builder.append("\n");
		builder.append("mesh.geometry.applyMatrix(mesh.matrixWorld);");
		builder.append("\n");
		builder.append("geometries.push(mesh.geometry.clone());");
		builder.append("\n");
		builder.append("mesh.parent.remove(mesh);");
		builder.append("\n");
		builder.append("});");
		builder.append("\n");
		builder.append("const geometry = THREE.BufferGeometryUtils.mergeBufferGeometries(geometries);");
		builder.append("\n");
		builder.append("this.mesh = new THREE.Mesh(geometry);");
		builder.append("\n");
		builder.append("this.el.setObject3D(\'mesh\', this.mesh);");
		builder.append("\n");
		builder.append("}});");
		builder.append("\n");
		builder.append("</script>");
